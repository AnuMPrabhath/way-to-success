package lk.ijse.waytosuccess.qr;
...
public class QrGenerator {
    ...
    public static void getGenerator() throws IOException, WriterException {
            path = "F:\\1st Semester\\Professional Software Project-Semester01\\QrGeneratorFill" + data + ".png";
