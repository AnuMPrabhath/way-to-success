package lk.ijse.waytosuccess.util;
...
public class Regex {
    ...
    public static boolean validateNIC(String nic) {return nic.matches(NIC_REGEX_1) || nic.matches(NIC_REGEX_2);}
    public static boolean validateName(String name) { return name.matches(NAME_REGEX);}
    public static boolean validateEmail(String email) {return email.matches(EMAIL_REGEX);}
    public static boolean validateMobile(String mobile) { return mobile.matches(MOBILE_REGEX);}
    public static boolean validateUsername(String username) {return username.matches(USERNAME_REGEX);}
    public static boolean validatePassword(String password) {return password.matches(PASSWORD_REGEX);}
    ...
    public static boolean validateZIP(String zipCode) {return zipCode.matches(ZIP_REGEX);}
